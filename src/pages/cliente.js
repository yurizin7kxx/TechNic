  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white font-sans">
      <nav className="bg-slate-800 border-b border-slate-700 p-4 flex justify-between items-center">
        {/* ALTERAÇÃO AQUI: O href agora aponta para /login */}
      ...
      <main className="p-6 md:p-10 grid md:grid-cols-3 gap-8">
        <div className="md:col-span-2 space-y-8">
          ...
          <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
            ...
            <textarea 
              rows="4" 
              placeholder="Adicionar nova observação técnica..." 
              className="w-full px-4 py-2.5 rounded-md bg-slate-700 border border-slate-600 text-white focus:ring-2 focus:ring-blue-500 outline-none resize-none mb-4"
            ></textarea>
            <div className="flex justify-end">
                <button className="bg-gray-600 hover:bg-gray-700 text-sm px-4 py-2 rounded-md font-medium transition">
                    Salvar Observação
                </button>
            </div>
          </div>
        ...
        <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 h-fit space-y-4">
          ...
          <button className="w-full bg-yellow-600 hover:bg-yellow-700 py-2 rounded-md text-sm font-medium transition">
            Aprovar Orçamento
          </button>
          <button className="w-full bg-green-600 hover:bg-green-700 py-2 rounded-md text-sm font-medium transition">
            Marcar como Concluído
          </button>
          <button className="w-full bg-red-600/20 text-red-400 border border-red-600/50 hover:bg-red-600/30 py-2 rounded-md text-sm font-medium transition">
            Gerar NF-e
          </button>
        </div>
      </main>
